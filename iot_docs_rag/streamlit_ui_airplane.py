...
from airplane_docs_rag_agent import airplane_docs_expert, AirplaneDocsDeps
...
async def run_agent_with_streaming(user_input: str):
    ...
    deps = AirplaneDocsDeps(supabase=supabase, openai_client=openai_client)
    ...
    async with airplane_docs_expert.run_stream(
        user_input,
        deps=deps,
...
async def main():
    st.title("Airplane Company Knowledge Base")
    st.write(
        "Ask any question about aircraft models, maintenance procedures, company policies, and aviation regulations."
    )
    ...
    user_input = st.chat_input("What questions do you have about our aircraft or aviation?")
