...
agent = Agent(
    "openai:gpt-4o-mini",
    deps_type=RAGDeps,
    system_prompt="You are a helpful assistant that answers questions about IoT devices and systems based on the provided documentation. "
    "Use the retrieve tool to get relevant information from the IoT documentation before answering. "
...
async def run_rag_agent(
    ...
    """Run the RAG agent to answer a question about IoT documentation.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run a RAG agent using ChromaDB for IoT documentation"
    )
    parser.add_argument("--question", help="The question to answer about IoT devices and systems")
